...
import { jobsQuickActions } from '@/features/jobs/data/constants'
...
export function JobsQuickActions({ onAction, className = '' }: JobsQuickActionsProps) {
  return (
    <div className={`space-y-3 ${className}`}>
      ...
      <div className="px-5">
        <div className="grid grid-cols-4 gap-3">
          {jobsQuickActions.map((action, index) => (
            <motion.div
              key={action.id}
